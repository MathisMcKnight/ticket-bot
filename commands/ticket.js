  ...
  async execute(interaction) {
    ...
    if (sub === 'blacklist') {
      ...
      try {
        ...
        return interaction.reply({ content: '❌ Error blacklisting user.', ephemeral: true });
      }
    }
    ...
    if (sub === 'unblacklist') {
      ...
      try {
        ...
        return interaction.reply({ content: '❌ Error unblacklisting user.', ephemeral: true });
      }
    }
    ...
    if (sub === 'close-all') {
      ...
      try {
        ...
        console.error('Error in close-all:', error);
    ...
    if (sub === 'transfer') {
      try {
        ...
        await interaction.reply({ content: '❌ Error initiating transfer.', ephemeral: true });
      }
    }
  },
};
