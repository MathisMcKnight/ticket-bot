...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .setColor('#0A235B')
      .addFields(
        { name: '⚙️ Setup Commands (Chief of Staff Only)', value: '`/setup` - Configure ticket system (opens setup wizard)\n`/panel` - Create ticket panel for users', inline: false },
